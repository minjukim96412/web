...
<body>
    ...
    <div id="questions">
        <div class="question active" id="question1">
            ...
            <img alt="" src="./image/testImg1.png">
        ...
        <div class="question" id="question2">
            ...
            <img alt="" src="./image/testImg2.png">        
            <div class="button-group">
        ...
        <div class="question" id="question3">
            ...
            <img alt="" src="./image/testImg3.png">
            <div class="button-group">
        ...
        <div class="question" id="question4">
            <p>여행지에서 주로 이용하는 이동수단은?</p>
           	<img alt="" src="./image/testImg4.png">
            <div class="button-group">
        ...
        <div class="question" id="question5">
            ...
            <img alt="" src="./image/testImg5.png">
            <div class="button-group">
        ...
        <div class="question" id="question6">
            <p>여행지에서 소비 패턴은?</p>
            <img alt="" src="./image/testImg6.png">
            <div class="button-group">
        ...
        <div class="question" id="question7">
            ...
            <img alt="" src="./image/testImg7.png">
            <div class="button-group">
